...
import { ParamValueMap, SearchParamsObject } from '@/lib/utils/types'
...
export const getSearchParams = (
  ...
  return {
    ...
    page: Number(searchParamsObject?.[page] || defaultPage),
    // Get the sort parameter or use the default value.
    sort:
      (searchParamsObject?.[sort] as ListSortingParameterValue) || defaultSort,
